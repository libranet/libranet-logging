# -*- coding: utf-8 -*-
# pylint: disable=C0103  # Constant name doesn't conform to pattern (invalid-name)
""""
...
extensions = ["sphinx.ext.autodoc", "sphinx.ext.doctest", "sphinx.ext.napoleon", "recommonmark"]
